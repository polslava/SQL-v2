 ...
 , (case when s.stop_reason = 'ќжидание_разгрузки' 

  or (s.stop_reason = 'ќжидание_погрузки' and s.StoppagesTime < /*&lt;*/ 3) /*мо€ доработка 20230422*/
then null else s.stop_reason end) as stop_reason                     /*мо€ доработка 20230420*/
 , (case when s.stop_reason = 'ќжидание_разгрузки' 
  or (s.stop_reason = 'ќжидание_погрузки' and s.StoppagesTime < /*&lt;*/ 3) /*мо€ доработка 20230422*/
then null else s.stop_reason_category end) as stop_reason_category   /*мо€ доработка 20230420*/
